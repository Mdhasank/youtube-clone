    ...
    <div className="flex justify-between  text-white px-14 h-14 items-center bg-[#212121] opacity-95 sticky">
          ...
          <div className="flex bg-zinc-900 items-center h-10 px-4 pr-0 rounded-3xl">
            <div className="flex gap-5 items-center pr-5">
              <input
                ...
                placeholder="Search"
                className="w-96 h-8
                        rounded-md bg-zinc-900 focus:out border-none text-white p-2"
              />
            </div>
      ...
      <div className="flex gap-8 items-center text-xl">
        ...
        <div className="relative">
          <BsBell />
          <span className="absolute bottom-2 left-2 text-xs bg-red-600 rounded-full p-1">
            7+
          </span>
        </div>
        <img src="https://images.pexels.com/photos/22931932/pexels-photo-22931932/free-photo-of-tenements-in-an-alley-in-town.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2" alt='profile photo' className="rounded-full w-9 h-9" />
      </div>
    </div>
  );
};
